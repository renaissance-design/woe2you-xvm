 ...
 */
{
    "circles": {
        ...
        "view": [
			...
			{ "enabled": true, "distance": 100, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 150, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 200, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 250, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 300, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 350, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 400, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 450, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
			{ "enabled": true, "distance": 500, "scale": 1, "thickness": 0.5, "alpha": 20, "color": "0xCCFFCC" },
